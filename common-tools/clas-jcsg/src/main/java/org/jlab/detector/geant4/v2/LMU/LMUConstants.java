...
public class LMUConstants {
    ...
    public final static int NREGIONS    = 6;    //number of regions (1 & 6 are GEM, 2-5 are URWELL) 
    ...
    public static double[] CHAMBERVOLUMESTHICKNESS;
    public static String[] CHAMBERVOLUMESNAME;
          
        public final static double[] GEM_CHAMBERVOLUMESTHICKNESS = {0.0025, 0.0005,0.3,                       // window
                                                                0.005, 0.0005,0.3,                            // cathode
                                                                0.005, 0.05, 0.005,                           // GEM layer 1
                                                                0.005, 0.05, 0.005,                           // GEM layer 2
                                                                0.005, 0.05, 0.005, 0.0028,                   // GEM layer 3
                                                                0.0037,  0.1, 0.0037,                         // Readout1
                                                                0.0125, 0.1, 0.0037};                         // Readout2

                                                            
       
        public final static double[] URWELL_CHAMBERVOLUMESTHICKNESS = {0.0025, 0.0005,0.3,                   // window
                                                               0.005, 0.0005,0.3,                            // cathode
                                                               0.0001, 0.005,                                // uRWell
                                                               0.0005, 0.0028,                               // DlC
                                                               0.0009, 0.0028,                               // Capacitive sharing layer1
                                                               0.0029, 0.0075,                               // Capacitive sharing layer2
                                                               0.0037,  0.1, 0.0037,                         // Readout1
                                                               0.0125, 0.1, 0.0037};                         // Readout2

        public final static String[] GEM_CHAMBERVOLUMESNAME = {"window_kapton", "window_Al", "window_gas",
                                                               "cathode_kapton", "cathode_Cu", "cathode_gas",
                                                               "gem1_Cu", "gem1_kapton", "gem1_Cu",
                                                               "gem2_Cu", "gem2_kapton", "gem2_Cu",
                                                               "gem3_Cu", "gem3_kapton", "gem3_Cu", "gem3_glue",
                                                               "readout1_Cu", "readout1_g10", "readout1_Cu", 
                                                               "readout2_glue", "readout2_g10", "readout2_Cu"};                                                       

        public final static String[] URWELL_CHAMBERVOLUMESNAME = {"window_kapton", "window_Al", "window_gas",
                                                          "cathode_kapton", "cathode_Cu", "cathode_gas",
                                                          "muRwell_Cu", "muRwell_kapton",
                                                          "dlc_dlc", "dlc_glue",
                                                          "capa_sharing_layer1_Cu","capa_sharing_layer1_glue",
                                                          "capa_sharing_layer2_Cu","capa_sharing_layer2_glue",
                                                          "readout1_Cu", "readout1_g10", "readout1_Cu", 
                                                          "readout2_glue", "readout2_g10", "readout2_Cu"};        
  ...
  //  public final static double ZMIN = W2TGT*Math.cos(Math.toRadians(THMIN));   
    ...
    static {
      for (int region = 1; region <= 6; region++) {
          initializeChamberArraysForRegion(region);
      }
  }

  public static void initializeChamberArraysForRegion(int region) {
      if (region == 1 || region == 6) { // GEM detectors
          CHAMBERVOLUMESTHICKNESS = GEM_CHAMBERVOLUMESTHICKNESS;
          CHAMBERVOLUMESNAME = GEM_CHAMBERVOLUMESNAME;
      } else { // URWELL detectors
          CHAMBERVOLUMESTHICKNESS = URWELL_CHAMBERVOLUMESTHICKNESS;
          CHAMBERVOLUMESNAME = URWELL_CHAMBERVOLUMESNAME;
      }
  }
